 ...
 <?php 
  // if(isset($_SESSION['username'])){
 	...
 	if($r['anhtrichdan'] != null)
		 ...
		 $string =  '<div>'.
		 '<div>'.
		 '<input type="button" value="Tóm Tắt"'.
		 ' style="display:inline-block;border:none;outline:none;width:140px;font-size:13px;color:#fff;margin:0px;padding:10px 32px;background-color:#78b43d;text-decoraton:none;border-radius:20px" onclick="if '.
		 ...
		 ' } else { '.
		 'this.parentNode.parentNode.getElementsByTagName(\'div\')[1].getElementsByTagName(\'div\')[0].style.display'.
		 ' = \'none\'; this.innerText = \'\'; this.value = \'Tóm Tắt\'; }">'.
		 '</div>'.
		 '<div>'.
