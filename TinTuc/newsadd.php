...
?>
 ...
 <?php 
      ...
      $idtheloai=$_POST['idtheloai'];
 			...
 			$noidung= html_entity_decode($_POST['noidung']);
			$Noi=preg_replace("/<img[^>]+\>/i", " ", $noidung);
			
 			$dt->command("INSERT INTO tinbai(idTheLoai,TieuDe,TrichDan,anhtrichdan,NoiDung,Noi) VALUES ('$idtheloai','$tieude','$trichdan','$anhtrichdan','$noidung','$Noi')");
