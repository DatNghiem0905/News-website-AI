...
<body>
    <div class="container-fluid">
        <div class="row">
            <a  name="dautrang" class="navbar-brand" href="index.php"><img src="image/Logo2.png"></a>
            <div class="col-md-12 ">
                ...
                <a href="index.php" class="btn"><img src="image/home.png" width="50px" height="40px" style="padding-bottom: 5px; padding-right: 3px;"></a>
                    <?php
                        ...
                        while ($r=$dt->fetch()) {
                                $id=$r['idTheLoai'];
                                $name= $r['tenloai'];
                                echo "<a href='news.php?id=$id' class='btn' style='font-size: 15px;'>$name</a>";
                            }
                    ?>
            </form>         
...
<div class="container">
    <!--<a href="https://www.icmarkets.com/the-ecn-brokerage-platform-for-real-traders/?camp=12234&gclid=EAIaIQobChMIw7fCr66U2gIVCV69Ch09jAl6EAEYASAAEgLfNvD_BwE"><img src="image/966541002590824287.png" width="1120px"></a>-->
    <div class="row">